...
Конечно! Ниже я подготовил аналогичный текст для вашего проекта с моделями `User`, `UserData`, `SleepRecord`, `NightHeartRateEntry`, `SleepSegment`, `SleepStatistics`. Я структурировал его так же, как ваш пример: логика работы, формирование данных, взаимодействие с сервисом.

---

### Формат данных для взаимодействия с AI-сервисом (Sleep Tracking)
